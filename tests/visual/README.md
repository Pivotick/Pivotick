...
| `edge-creation`         | Edge created via the editing layer; click-to-connect shadow preview + commit; drag-to-connect preview (snap-to-node arc vs cursor-tracking line) + commit-on-drop; Escape cancel |
